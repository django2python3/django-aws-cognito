"""
Django settings for djangocognito project.
...
PROJECT_APPS = Path(__file__).ancestor(1)
...
SECRET_KEY = 'lc6!y2as6zn2s$a0@-=jp0e1*=6#a90i+=ayvr@-b26@v6d%-*'
...
ROOT_URLCONF = 'djangocognito.urls'
...
WSGI_APPLICATION = 'djangocognito.wsgi.application'
